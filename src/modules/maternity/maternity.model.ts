...
export class MaternityRecordModel extends Document {
  @Prop({
    required: true,
    ref: 'Patient',
  ...
  emergencyMedicinesAdministrations: maternityEmergencyRequest[];
...
export const MaternityRecordSchema =
  SchemaFactory.createForClass(MaternityRecordModel);
